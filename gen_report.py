...
def get_objects(object_type, aoi):
    ...
    #determine index
    idx_dct = {'ifg':'grq_*_s1-gunw-standard-product', 'acq-list':'grq_*_acq-list', 'ifg-cfg': 'grq_*_ifg-cfg', 'ifg-blacklist':'grq_*_blacklist', 'slc': 'grq_*_s1-iw_slc', 'acq': 'grq_*_acquisition-s1-iw_slc'}
